...
public class ExampleMouseEvents {
	public ExampleMouseEvents(Stage theStage){
        ...
        Image bullseye = new Image( getClass().getResource("../resources/bullseye.png" ).toExternalForm());
